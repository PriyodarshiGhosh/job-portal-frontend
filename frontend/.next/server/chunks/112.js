...
/* harmony export */   "Z": () => (/* binding */ CreateJob)
/* harmony export */ });
...
function CreateJob() {
    ...
    const { handleSubmit  } = (0,_views_useCreateJob__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(title, description, location, salary);
...
const useCreateJobView = (title, description, location, salary)=>{
